"""Component catalog and discovery registry for SQCanvas."""
...
class ComponentMeta:
    """Metadata descriptor for a registered SQCanvas component."""
...
def _build_catalog() -> list[ComponentMeta]:
    from sqcanvas.components.coupler import ChargeArc, ChargeClaw, ChargeTee, ReadTee
    from sqcanvas.components.marker import AlignmentMarker, CasingMarker, Marker, PackagingMarker
    ...
    from sqcanvas.components.text import Text
