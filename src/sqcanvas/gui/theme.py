"""Theme and design system definitions for SQCanvas GUI.
...
QTabBar {{
    background-color: {Palette.BG_DARKEST};
    border-bottom: 1px solid {Palette.BORDER_SUBTLE};
...
QTabBar::tab:selected {{
    background-color: {Palette.BG_SURFACE};
    color: {Palette.ACCENT_CYAN};
    border-top: 2px solid {Palette.ACCENT_CYAN};
    border-bottom: 1px solid {Palette.BG_SURFACE};
    font-weight: bold;
}}
...
def apply_dark_theme(target: QApplication | QWidget) -> None:
    """Apply the SQCanvas dark engineering theme to an application or root widget."""
