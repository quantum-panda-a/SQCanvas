"""Component Palette Dock Widget for browsing, filtering, and selecting components in QCanvas."""
...
from qcanvas.components.registry import COMPONENT_CATALOG, ComponentMeta
